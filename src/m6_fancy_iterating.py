...
def print_all_items_backwards(sequence):
    ...
    for x in range(len(sequence)):
        print(sequence[len(sequence) - (x + 1)])
...
def print_items_at_odd_indices(sequence):
    ...
    for x in range(len(sequence) // 2):
        print(sequence[1 + 2 * x], "is at index", (1 + 2 * x))
...
def print_items_in_second_half(sequence):
    ...
    for x in range((len(sequence) // 2) + (len(sequence) % 2)):
        print(sequence[(len(sequence) // 2) + x])
...
def print_items_that_are_bigger_than_5(sequence):
    ...
    for x in range(len(sequence)):
        if sequence[x] > 5:
            print(sequence[x], "is at index", x)
