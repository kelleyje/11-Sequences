...
def run_test_count_items_bigger_than():
    ...
    sequence = [-128, -64, -32, -16, -8, -4, -2, -1, -0.5, 0, 0.5, 1, 257]
    threshold = -256
    expected = 13
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([0, 1, 2, 3, -1, -2, -3])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 2
    actual = sum_first_n([0, -2, -4, -8, -16, -32, 64, 128, 256], 7)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
